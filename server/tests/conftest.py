...
class FakeAgent:
    ...
    async def start(self, channel_name, agent_uid, user_uid, output_audio_codec=None, filler_words_mode=None):
        self.started.append((channel_name, agent_uid, user_uid, output_audio_codec, filler_words_mode))
